...
! function (a) {
    ...
    a.matchMedia = a.matchMedia || function (a) {
        ...
        return f.id = "mq-test-1", f.style.cssText = "position:absolute;top:-100em", e.style.background = "none", e
            .appendChild(f),
            function (a) {
                return f.innerHTML = '­<style media="' + a + '"> #mq-test-1 { width: 42px; }</style>', c.insertBefore(
                ...
                for (var v in l)
                    if (l.hasOwnProperty(v)) {
                        var w = l[v],
                            ...
                            A = null === y,
                            B = "em";
                        x && (x = parseFloat(x) * (x.indexOf(B) > -1 ? i || t() : 1)), y && (y = parseFloat(y) * (y.indexOf(
                                B) > -1 ? i || t() : 1)), w.hasquery && (z && A || !(z || e >= x) || !(A || y >= e)) ||
            ...
            x = function () {
                for (var b = 0; b < s.length; b++) {
                    ...
                    e && g && !o[e] && (c.styleSheet && c.styleSheet.rawCssText ? (v(c.styleSheet.rawCssText, e, f), o[
                        e] = !0) : (!/^([a-zA-Z:]*\/\/)/.test(e) && !r || e.replace(RegExp.$1, "").split("/")[0] ===
